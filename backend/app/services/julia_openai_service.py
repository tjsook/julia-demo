        ...
        messages = [
            ...
            },
            {
                ...
                "content": (
                    ...
                    "Example — rep says \"doesn't bill detention 90% of the time\":\n"
                    "- MATCH detention_not_billed with evidence \"doesn't bill detention 90% of the time\"\n"
                    "Example — rep says \"no way of doing auto billing\":\n"
                    "- MATCH detention_not_billed with evidence \"no way of doing auto billing\"\n"
                    ...
                    "Example — rep says \"manually entering all orders into McLeod\":\n"
                    "- MATCH manual_order_entry with evidence \"manually entering all orders into McLeod\"\n"
                    "Example — rep says \"three minutes per entry\":\n"
                    "- MATCH manual_order_entry with evidence \"three minutes per entry\"\n"
                    "Example — rep says \"empty miles and HOS violations\":\n"
                    "- MATCH low_revenue_per_truck with evidence \"empty miles and HOS violations\"\n"
        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Treat detention-not-billed and no auto-billing wording as detention_not_billed. "
                    "Treat manual order-entry wording (including McLeod entry and minutes-per-entry) as manual_order_entry. "
                    "Treat empty-miles plus HOS-violation wording as low_revenue_per_truck."
                ),
            },
            {
                "role": "user",
                "content": (
                    ...
                    "- 'doesn't bill detention 90% of the time' -> MATCH detention_not_billed\n"
                    "- 'no way of doing auto billing' -> MATCH detention_not_billed\n"
                    "- 'manually entering all orders into McLeod' -> MATCH manual_order_entry\n"
                    "- 'three minutes per entry' -> MATCH manual_order_entry\n"
                    "- 'empty miles and HOS violations' -> MATCH low_revenue_per_truck\n\n"
                    "Pain point context:\n"
                    + "\n".join(
                        f"- {pain.id} ({pain.label}): {', '.join(pain.trigger_phrases)}"
                        for pain in pain_points
